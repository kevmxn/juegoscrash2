...
async def websocket_handler(request):
    ...
    async with client_semaphore:
        ...
        try:
            ...
            logger.info(f"Cliente Spaceman conectado, enviados últimos {HISTORY_SEND_LIMIT} eventos")
            async for msg in ws:
...
async def main():
    logger.info("=" * 60)
    logger.info("🚀 Monitor exclusivo de SPACEMAN con WebSocket, batching y solo últimos 20 eventos")
    logger.info("=" * 60)
    tasks = [
